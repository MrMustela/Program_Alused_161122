...
namespace LINQ
{
    internal class Program
    {
        ...
        {
            //see eraldab teises nimekirjas olevad väärtused esimesest
            //ja kuvab viimases nimekirjas olevaid mitte korduvaid väärtuseid
            IList<string> strList1 = new List<string>() { "One", "Two", "Three", "Four", "Five" };
            IList<string> strList2 = new List<string>() { "Four", "Five", "Six", "Seven", "Eight" };
        ...
        {
            //võrdleb kahte nimekirja ja sarnaseid väärtuseid ei kuva
            Console.WriteLine("-------------------------------------");
            IList<string> strList1 = new List<string>() { "One", "Two", "Three", "Four", "Five" };
            IList<string> strList2 = new List<string>() { "FOUR", "Five", "SIX", "Seven", "Eight" };
