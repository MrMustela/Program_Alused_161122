...
namespace Hindelinetöö_20dets
{
    internal class Program
    {
        ...
        private static void Triangle()
        {
            ...
            Console.WriteLine("Kodus võin ise edasi mõelda, et kuidas pindala kätte saada. Hetkel olen suutnud saada kolmnurga aluse ja ümbermõõdu arvu. Ma olen ikka nii kuradi aeglane.");
